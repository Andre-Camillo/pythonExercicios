...
tirar = int(input('INFORME O VALOR A SER RETIRADO: '))
if tirar in valores:
    valores.remove(tirar)
    print(f'O VALOR "{tirar}" FOI REMOVIDO COM SUCESSO')
else:
    print(f'O VALOR "{tirar}" NÃO APARECE NA LISTA')
for c in valores:
    print(f'{c}', end=' ')
